...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if value_one_die == 1:
            ...
            point_roll_dice = point_roll_dice + value_one_die
    if has_value_one == True:
        point_roll_dice = 1
    return point_roll_dice
    # END PROBLEM 1
...
def tail_points(opponent_score):
    ...
    ones_score = opponent_score % 10
    point_zero_dice = 2 * abs(tens_score - ones_score) + 1
    return point_zero_dice
    # END PROBLEM 2
...
def perfect_square(score):
    return sqrt(score) == int(sqrt(score))
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    while num_rolls <= 10:
        ...
        average_list.append(roll_average(num_rolls, dice))
        num_rolls = num_rolls + 1
    max_item = max(average_list)
    return average_list.index(max_item) + 1
...
def final_strategy(score, opponent_score):
    ...
    *** This strategy returns 0 dice in 2 circumstances
    1. when your score would increase by at least 6, or 
    2. when the difference between GOAL and your score is lower than 7, 
    i.e., 4^2 - 3^2, which is a median.  
    This can sometimes work better than the square_strategy above. ***
    """
    # BEGIN PROBLEM 12
    square_update_00 = square_update(0, score, opponent_score)
    square_update_01 = square_update(1, score, opponent_score)
    square_update_02 = square_update(2, score, opponent_score)
    square_update_06 = square_update(6, score, opponent_score)
    roll_06 = 6 + score

    if  square_update_00 >= roll_06 or GOAL - score <= 7:
        return 0
    else:
